...
import { registerProducaoWeekScroll } from './producao-week-scroll.js';
import { registerSidePanel } from './side-panel.js';
import { registerTaskPopup } from './task-popup.js';
...
import { registerInlineField } from './inline-field.js';
...
registerKanbanDnd();
registerProducaoWeekScroll();
registerSidePanel(Alpine);
registerTaskPopup(Alpine);
registerLiveFilter();
registerConfirmDialog(Alpine);
registerInlinePatch();
registerInlineField(Alpine);
