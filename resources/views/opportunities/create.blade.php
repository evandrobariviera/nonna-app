            ...
            <div class="card p-6 space-y-5">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" name="proposed_fee" value="{{ old('proposed_fee') }}" min="0" step="0.01"
                    ...
                    <div>
                        ...
                        <input type="number" name="proposed_ad_budget" value="{{ old('proposed_ad_budget') }}" min="0" step="0.01"
                               class="w-full bg-[var(--s3)] border border-[var(--border2)] text-sm text-[var(--text)] px-4 py-2.5 focus:outline-none focus:border-[var(--purple)]">
                    </div>
                </div>
