<x-app-layout>
    <x-slot name="header">Nova novidade</x-slot>
    ...
    <form action="{{ route('app-updates.store') }}" method="POST" style="max-width:860px">
        @csrf
        @include('novidades._form', ['update' => null, 'areas' => $areas])
