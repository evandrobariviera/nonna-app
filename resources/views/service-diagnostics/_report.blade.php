{{-- Corpo do relatório do Diagnóstico de Atendimento — compartilhado entre a
     tela interna (show.blade.php) e a versão de impressão/exportação (print.blade.php).
     Espera $diagnostic e $integration no escopo. --}}
@php
