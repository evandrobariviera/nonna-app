...
<head>
    ...
    <title>Cadastro Concluído · Nonna</title>
...
<body>
    <div style="text-align:center; max-width:480px; padding:40px 24px">
        <div style="width:64px; height:64px; border-radius:50%; background:rgba(52,211,153,.1); border:1px solid rgba(52,211,153,.3); display:flex; align-items:center; justify-content:center; margin:0 auto 24px; font-size:26px">
            ✓
        </div>
        <h1 style="font-size:28px; font-weight:800; margin-bottom:12px">
            Cadastro <span class="grad-text">concluído!</span>
        </h1>
