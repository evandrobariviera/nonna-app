<x-app-layout>
    <x-slot name="header">Editar Artigo — Central de Ajuda</x-slot>
    ...
    <form action="{{ route('help.update', $article) }}" method="POST" style="max-width:860px">
        @csrf @method('PATCH')
        ...
        <div class="card px-6 py-5">
            <div class="grid gap-4">
                <div>
                    ...
                    <input type="text" name="title" value="{{ old('title', $article->title) }}" required autofocus
                ...
                <div>
                    ...
                    <input type="text" name="category" value="{{ old('category', $article->category) }}" list="category-options"
                ...
                <div>
                    ...
                    <x-rich-editor name="body" :value="old('body', $article->body)" min-height="320px"
                                   :upload-url="route('help.editor-image.store', $article)" />
                </div>
            </div>
        </div>
        ...
        <div class="flex items-center gap-4 mt-5">
            ...
            <a href="{{ route('help.show', $article) }}" class="btn btn-ghost btn-sm">Cancelar</a>
        </div>
    </form>
