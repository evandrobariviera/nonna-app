<div style="max-width:800px"
    ...
    <form method="POST" action="{{ $action }}">
        ...
        <div class="grid gap-5">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    <label class="block text-xs font-semibold mb-1"
                           style="color:var(--muted); font-family:'IBM Plex Mono',monospace; letter-spacing:.05em">NOME DO AGENTE *</label>
                ...
                <div>
                    <label class="block text-xs font-semibold mb-1"
                           style="color:var(--muted); font-family:'IBM Plex Mono',monospace; letter-spacing:.05em">DESCRIÇÃO</label>
            ...
            <div>
                <label class="block text-xs font-semibold mb-1"
                       style="color:var(--muted); font-family:'IBM Plex Mono',monospace; letter-spacing:.05em">SYSTEM PROMPT (SKILL DO AGENTE) *</label>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    <label class="block text-xs font-semibold mb-1"
                           style="color:var(--muted); font-family:'IBM Plex Mono',monospace; letter-spacing:.05em">PROVIDER *</label>
                ...
                <div>
                    <label class="block text-xs font-semibold mb-1"
                           style="color:var(--muted); font-family:'IBM Plex Mono',monospace; letter-spacing:.05em">MODELO *</label>
            ...
            <div>
                <label class="block text-xs font-semibold mb-1"
                       style="color:var(--muted); font-family:'IBM Plex Mono',monospace; letter-spacing:.05em">CHAVE DE API ESPECÍFICA <span style="font-weight:400">(opcional — usa a padrão do provider se vazio)</span></label>
            ...
            <div class="grid grid-cols-3 gap-4">
                <div>
                    <label class="block text-xs font-semibold mb-1"
                           style="color:var(--muted); font-family:'IBM Plex Mono',monospace; letter-spacing:.05em">TEMPERATURE</label>
                ...
                <div>
                    <label class="block text-xs font-semibold mb-1"
                           style="color:var(--muted); font-family:'IBM Plex Mono',monospace; letter-spacing:.05em">MAX TOKENS</label>
                ...
                <div>
                    <label class="block text-xs font-semibold mb-1"
                           style="color:var(--muted); font-family:'IBM Plex Mono',monospace; letter-spacing:.05em">CONTEXTO</label>
